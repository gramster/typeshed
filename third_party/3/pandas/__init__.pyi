...
def read_csv(
    ...
    true_values: Optional[List[_Scalar]] = ...,
...
def read_excel(
    ...
    keep_default_na: bool = ...,
    verbose: bool = ...,
    parse_dates: Union[bool, List, Dict[str, List]] = ...,
    date_parser: Optional[Callable] = ...,
    thousands: Optional[str] = ...,
    comment: Optional[str] = ...,
    skipfooter: int = ...,
...
def read_fwf(
    filepath: Union[str, Path],
    colspecs: Union[List[Tuple[int, int]], Literal["infer"]] = ...,
...
def read_html(
    io: Union[str, Path, IO],
    match: str = ...,
    flavor: Optional[str] = ...,
    header: Optional[Union[int, List[int]]] = ...,
    index_col: Optional[Union[int, Sequence]] = ...,
    skiprows: Optional[Union[int, Sequence, slice]] = ...,
...
def read_pickle(
    filepath_or_buffer_or_reader: _Path_or_Buf,
    compression: Optional[Literal["infer", "gzip", "bz2", "zip", "xz"]] = ...,
) -> Any: ...
def read_parquet(
    path: Union[str, Path, IO], engine: str = ..., columns: Optional[List[str]] = ..., **kwargs
) -> DataFrame: ...
def read_sas(
    path: Union[str, Path, IO],
    format: Optional[str] = ...,
...
def read_spss(
    path: Union[str, Path, IO], usecols: Optional[Sequence[str]] = ..., convert_categoricals: bool = ...,
) -> DataFrame: ...
def read_sql(
    sql: Union[str, Any],
    con: Union[str, Any] = ...,
...
def read_sql_query(
    ...
    coerce_float: bool = ...,
    params: Any = ...,
    parse_dates: Optional[Union[List[str], Dict[str, str]]] = ...,
    chunksize: Optional[int] = ...,
) -> DataFrame: ...
def read_sql_table(
    table_name: str,
...
def concat(
    ...
    levels: Optional[List[Union[int, str]]] = ...,
    names: Optional[List[str]] = ...,
...
def melt(
    frame: DataFrame,
    id_vars: Union[Tuple, List, _np.ndarray] = ...,
    value_vars: Any = ...,
...
def period_range(
    start: Any = ..., end: Any = ..., periods: Any = ..., freq: Any = ..., name: Any = ...,
) -> PeriodIndex: ...
def pivot(
    data: DataFrame,
    index: Optional[str] = ...,
...
def qcut(
    x: Any, q: Any, labels: Any = ..., retbins: bool = ..., precision: int = ..., duplicates: str = ...,
) -> Tuple[Any, Any]: ...
def reset_option(pat: str) -> None: ...
def set_option(pat: str, value: Any) -> None: ...
def timedelta_range(
    start: Any = ..., end: Any = ..., periods: Any = ..., freq: Any = ..., name: Any = ..., closed: Any = ...,
) -> TimedeltaIndex: ...
def to_datetime(
    arg: Any,
    errors: str = ...,
